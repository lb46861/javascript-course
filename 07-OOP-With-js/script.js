...
jay.init('Jay', 2000, 'Computed Science');
jay.introduce();
jay.calcAge();
...
class Account {
  ...
  static helper() {
    console.log('Hello, I am here to help!');
  }
...
class CarCl {
  ...
  accelerate() {
    this.speed += 10;
    console.log(`Rivian is currently driving ${this.speed}km/h.`);
  }
...
class EVCl extends CarCl {
  ...
  accelerate() {
    ...
    this.#charge--;
    console.log(
      `Rivian is currently driving ${this.speed}km/h with a charge of ${
        this.#charge
      }`
    );
    return this;
