...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-01-04T18:49:59.371Z',
    '2022-01-05T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
/////////////////////////////////////////////////
// Functions
const formatMovementDate = function (myDate, locale) {
  const calcDaysPassed = (date1, date2) =>
    Math.round(Math.abs(date2 - date1) / (1000 * 60 * 60 * 24));

  const daysPassed = calcDaysPassed(new Date(), myDate);
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayMyDate = formatMovementDate(myDate, acc.locale);
    ...
    const html = `
      ...
      i + 1
        ...
        <div class=movements__date">${displayMyDate}</div>
...
const startLogoutTimer = function () {
  const tick = function () {
    ...
    // When timer exoures stop timer and log out user
    if (time === 0) {
      clearInterval(timer);
...
// Parsing - works if string starts with number
console.log(Number.parseInt('110px', 10)); // returns 30
...
console.log(Math.max(5, 1, 18, 2, 1));
console.log(Math.max(5, 1, '18', 2, 1));
console.log(Math.max(5, 1, '18px', 2, 1));

console.log(Math.min(5, 1, 18, 2, 1));

console.log(Math.PI * Number.parseFloat('10px') ** (1 / 2));
...
console.log(new Date('Jan 04 2020 18:05:41'));
console.log(new Date('December 24, 2015'));
console.log(new Date(account1.movementsDates[0]));

console.log(new Date(2037, 9, 19, 15, 23, 5));
